<template>
    <section class="welcome">
        <div class="container align-items-center">
            ...
            <img src="@/assets/img/home.png" class="welcome__img" alt="Умный дом">
        </div>
    </section>
    ...
    <section class="order">
        <div class="container">
            <img src="@/assets/img/доля_рынка.jpg" class="order__img">
    ...
    <section class="feedback">
        <div class="container">
            <img src="@/assets/img/feedback.png" class="feedback__img">
